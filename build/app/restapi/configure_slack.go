...
//go:generate swagger generate server --target ../../app --name Slack --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/slack/build/templates --principal interface{}

func configureFlags(api *operations.SlackAPI) {
...
func configureAPI(api *operations.SlackAPI) http.Handler {
